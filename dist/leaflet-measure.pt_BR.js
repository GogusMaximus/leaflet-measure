!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      ' <ul class=tasks> <li><a href=# class="js-deletemarkup deletemarkup">Excluir</a></li> </ul> ';
  },
  function(e, t) {
    e.exports =
  ...
  function(e, t, r) {
    e.exports =
      '<div> <h3 class=content>Medida de área<a href=# class="js-deletemarkup deletemarkup"></a></h3> </div> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Perímetro</p> ';
  }
]);
