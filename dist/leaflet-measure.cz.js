!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      ' <ul class=tasks> <li><a href=# class="js-deletemarkup deletemarkup">smazat</a></li> </ul> ';
  },
  function(e, t) {
    e.exports =
  ...
  function(e, t, r) {
    e.exports =
      '<div> <h3 class=content>naměřená výměra<a href=# class="js-deletemarkup deletemarkup"></a></h3> </div> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} okraj</p> ';
  }
]);
