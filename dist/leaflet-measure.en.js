!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Measure distance">Measure</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Measure distance</h3> <ul class=tasks> <a href=# class="js-start start">New measurement</a> </ul> </div> <div class=js-measuringprompt> <h3>Measure distance</h3> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel"><i class="fa-solid fa-trash-can"></i>Cancel</a></li> <li><a href=# class="js-finish finish">Finish</a></li> </ul> </div> </div> ';
  },
  function(e, t) {
    e.exports = ' ';
  },
  function(e, t, r) {
    e.exports =
      ' <ul class=tasks> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> ';
  },
  function(e, t) {
    e.exports =
  ...
  function(e, t, r) {
    e.exports =
      '<div> <h3 class=content>Area<a href=# class="js-deletemarkup deletemarkup"></a></h3> </div> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Perimeter</p> ';
  }
]);
