!(function(e) {
    ...
    function n(e, t, r) {
      ...
      var w,
        ...
        D = M.call(t, 'sourceURL')
          ...
          : '';
      e.replace(C, function(t, r, n, o, i, a) {
        return (
          n || (n = o),
          (A += e.slice(E, a).replace(x, u)),
          r && ((w = !0), (A += "' +\n__e(" + r + ") +\n'")),
          i && ((O = !0), (A += "';\n" + i + ";\n__p += '")),
          n && (A += "' +\n((__t = (" + n + ")) == null ? '' : __t) +\n'"),
          (E = a + t.length),
      ...
      (A = (O ? A.replace(y, '') : A).replace(v, '$1').replace(g, '$1;')),
        (A =
          ...
          'return __p\n}');
      var $ = i(function() {
        return Function(L, D + 'return ' + A).apply(void 0, P);
      });
      if ((($.source = A), c($))) throw $;
      return $;
    }
  ...
  function(e, t, r) {
    e.exports =
      ' <ul class=tasks> <li><a href=# class="js-deletemarkup deletemarkup">Tanggalin</a></li> </ul> ';
  },
  function(e, t) {
    e.exports =
  ...
  function(e, t, r) {
    e.exports =
      '<div> <h3 class=content>Kabuuang sukat<a href=# class="js-deletemarkup deletemarkup"></a></h3> </div> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Palibot</p> ';
  }
]);
