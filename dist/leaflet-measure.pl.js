!(function(e) {
        ...
        for (
          ...
          for (var b = 0; b < u; b++) {
            ...
            if (null !== (a = f ? l.geometries[b] : l)) {
              c = a.coordinates;
              var j = a.type;
              switch (((p = !r || ('Polygon' !== j && 'MultiPolygon' !== j) ? 0 : 1), j)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(c, h, g, _, w)) return !1;
                  h++, _++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (o = 0; o < c.length; o++) {
                    if (!1 === t(c[o], h, g, _, w)) return !1;
                    h++, 'MultiPoint' === j && _++;
                  }
                  'LineString' === j && _++;
                  break;
                ...
                case 'MultiLineString':
                  for (o = 0; o < c.length; o++) {
                    for (i = 0; i < c[o].length - p; i++) {
                      if (!1 === t(c[o][i], h, g, _, w)) return !1;
                      h++;
                    }
                    'MultiLineString' === j && _++, 'Polygon' === j && w++;
                  }
                  'Polygon' === j && _++;
                  break;
                case 'MultiPolygon':
                  for (o = 0; o < c.length; o++) {
                    for ('MultiPolygon' === j && (w = 0), i = 0; i < c[o].length; i++) {
                      for (s = 0; s < c[o][i].length - p; s++) {
                        if (!1 === t(c[o][i][s], h, g, _, w)) return !1;
                        h++;
                      }
                      w++;
                    }
  ...
  function(e, t, r) {
    e.exports =
      ' <ul class=tasks> <li><a href=# class="js-deletemarkup deletemarkup">Skasuj</a></li> </ul> ';
  },
  function(e, t) {
    e.exports =
  ...
  function(e, t, r) {
    e.exports =
      '<div> <h3 class=content>Pomiar powierzchni<a href=# class="js-deletemarkup deletemarkup"></a></h3> </div> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Obwód</p> ';
  }
]);
