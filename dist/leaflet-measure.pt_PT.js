!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<div> <h3 class=content>Medição da área<a href=# class="js-deletemarkup deletemarkup"></a></h3> </div> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Perímetro</p> ';
  }
]);
